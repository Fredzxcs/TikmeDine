...
from .views import (
    setup_account, setup_password, admin_login, portal, 
    system_admin_login, system_admin_dashboard, change_status, 
    send_onboarding_email, send_reset_password_email_logic, 
    send_account_reactivation_email, reset_password, 
    reactivate_account, add_employee, forgot_password
)
...
urlpatterns = [
    ...
    path('send_reset_password_email/<int:employee_id>/', send_reset_password_email_logic, name='send_reset_password_email'),
